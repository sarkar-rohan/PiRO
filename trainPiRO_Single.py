...
# instantiate model 
trcv_model = SingleModel(Config.inpChannel, Config.embedDim, hp.nHeads, hp.nLayers, hp.dropout, Config.Ncls).to(device)
print(trcv_model)
...
trcv_model.eval()
orm, crm, clea, svoc = evaluate_performance_single(dataset, Config, trcv_model, 1)
mvcrm, mvclea, mvoc, mvoret = evaluate_performance_single(dataset, Config, trcv_model, Config.N_G)
